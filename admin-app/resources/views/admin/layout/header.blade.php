  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="index-2.html">
        <img src="{{asset('admin/assets/img/foodtech/foodtech-logo-216x62.png' )}}">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="dashboard" class="collapse" aria-labelledby="dashboard" data-parent="#side-nav-accordion">
          <li> <a href="/Resturent"><span style="color:blue">My Resturent Shop</span></a>
          </li>
        </ul>
      </li>
       <!-- /Dashboard -->
...
<li class="menu-item">
        ...
        <ul id="product" class="collapse" aria-labelledby="product" data-parent="#side-nav-accordion">
          ...
          <li> <a href="{{ url('/menuAdd') }}">Add Product</a>
          </li>
          <li> <a href="{{ url('/getall') }}">Product Detail</a>
          </li>
        </ul>
      </li>
      <!-- product end -->
      <!-- orders -->
      <li class="menu-item">
        <a href="{{url('/elements')}}"> <span><i class="fas fa-clipboard-list fs-16"></i>Orders</span>
        </a>
      </li>
      <!-- orders end -->
      <!-- restaurants -->
      ...
      <li class="menu-item">
        ...
        <ul id="customer" class="collapse" aria-labelledby="customer" data-parent="#side-nav-accordion">
          ...
          <li> <a href="/Userdata">Customers List</a>
          </li>
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="index-2.html"><img src="assets/img/foodtech/foodtech-logo-84x41.png" alt="logo"> </a>
      </div>
...
<div class="ms-chat-status ms-status-offline ms-chat-img mr-2 align-self-center">
  <img src="{{ asset('admin/assets/img/foodtech/country.jpg') }}" class="ms-img-round" alt="Apple">
//"C:\Rajxampp\htdocs\Resturent\Resturnt-app\admin-app\public\admin\assets\img\foodtech\country.jpg"
                </div>
