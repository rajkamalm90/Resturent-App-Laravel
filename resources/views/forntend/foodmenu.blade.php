                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-6">
                                    <div class="single_food_item media">
                                        <img src="{{ asset('forntend/img/food_menu/single_food_1.png') }}" class="mr-3" alt="Pork Sandwich">
                                        <div class="media-body align-self-center">
                                            <h3>Sandwich</h3>
                                            <p>They're wherein heaven seed </p>
                                            <h5>$40.00</h5>
                                        </div>
                                    </div>
                            
                                    <div class="single_food_item media">
                                        <img src="{{ asset('forntend/img/food_menu/single_food_2.png') }}" class="mr-3" alt="Pork Sandwich">
                                    ...
                                    <div class="single_food_item media">
                                        <img src="{{ asset('forntend/img/food_menu/single_food_3.png') }}" class="mr-3" alt="Pork Sandwich">
                                        <div class="media-body align-self-center">
                                ...
                                <div class="col-sm-6 col-lg-6">
                                    <div class="single_food_item media">
                                        <img src="{{ asset('forntend/img/food_menu/single_food_4.png') }}" class="mr-3" alt="Pork Sandwich">
                                        <div class="media-body align-self-center">
                                    ...
                                    <div class="single_food_item media">
                                        <img src="{{ asset('forntend/img/food_menu/single_food_5.png') }}" class="mr-3" alt="Pork Sandwich">
                                        <div class="media-body align-self-center">
                                    ...
                                    <div class="single_food_item media">
                                        <img src="{{ asset('forntend/img/food_menu/single_food_6.png') }}" class="mr-3" alt="Pork Sandwich">
                                        <div class="media-body align-self-center">
                                            <h3>Sandwich</h3>
                                            <p>They're wherein heaven seed </p>
                                            <h5>$40.00</h5>
                        ...
                        <div class="tab-pane fade single-member" id="Breakfast" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-6">
                                    ...
                                    <div class="single_food_item media">
                                        <img src="{{ asset('forntend/img/food_menu/pork_sandwich.png') }}" class="mr-3" alt="Pork Sandwich">
                                        <div class="media-body align-self-center">
                                            <h3>Sandwich</h3>
                                            <p>They're wherein heaven seed </p>
                                            <h5>$40.00</h5>
